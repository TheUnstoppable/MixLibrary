...
namespace MixLibrary
{
    ...
    0xb3667a2e, 0xc4614ab8, 0x5d681b02, 0x2a6f2b94, 0xb40bbe37, 0xc30c8ea1, 0x5a05df1b, 0x2d02ef8d};
        ...
        internal static uint Calculate(string data, uint crc = 0) => Calculate(Encoding.Default.GetBytes(data), crc);
        internal static uint Calculate(byte[] data, uint crc = 0)
        {
            crc = ~crc;
            foreach (byte bdat in data)
                crc = (crc >> 8) ^ CRCTable[(crc & 0xFF) ^ bdat];
            return ~crc;
        }
    }
}
